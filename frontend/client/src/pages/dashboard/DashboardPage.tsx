...
function Dashboard({ onToast }: { onToast: (message: string) => void }) {
  ...
  return <><AmbientShards variant="dashboard" />
    ...
    <div className="metric-grid"><MetricCard label="Total leads" value="1,284" delta="12.8%" note="vs. previous 30 days" icon={Users} /><MetricCard label="Hot leads" value="186" delta="8.4%" note="14.5% of pipeline" accent="violet" icon={Target} /><MetricCard label="Conversations" value={conversationsTotal.isPending ? "…" : String(conversationsTotal.data?.total ?? "—")} delta="live total" note="text conversations" accent="amber" icon={MessageSquareText} /><MetricCard label="Qualification rate" value="72.4%" delta="6.1%" note="+4.2 pts this week" accent="green" icon={Gauge} /></div>
