  ...
  const rows = useMemo(
    () =>
      (list.data?.leads ?? [])
        ...
        .filter(({ display: l }) => tier === "All signals" || l.tier === tier),
    [list.data, tier]
  );
